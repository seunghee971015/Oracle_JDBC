...
/*
    1. INSERT
       ...
       테이블의 모든 컬럼에 대한 값을 직접 제시해서 한 행을 INSERT하고하 할때
...
/*
    ...
    => NOT NULL제약조건이 걸려있는 컬럼은 반드시 직접 값을 제시해야한다.
    단, 기본값(DEFAULT)이 지정되어 있으면 NULL이 아닌 기본값이 들어감
*/

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO,JOB_CODE, HIRE_DATE)
VALUES(901,'최지원','870918-1456123','J7', SYSDATE);
